...
A copy of the plugin can be downloaded from {Little Stream Software}[https://projects.littlestreamsoftware.com/projects/support-hours/files] or from {GitHub}[http://github.com/edavis10//redmine_project_support_hours]
...
<tt>
$ patch -p1 < vendor/plugins/redmine_project_support_hours.patch
</tt>
